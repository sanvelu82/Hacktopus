...
async def upload_resume(file: UploadFile = File(...)):
    ...
    try:
        ...
        similarity = util.pytorch_cos_sim(encoded_resume, encoded_job).item() + 0.3
...
async def send_email(candidate_email: str):
    ...
    """
    candidate_email = candidate_email.strip().replace("\n", "").replace("\r", "")
    try:
        SMTP_SERVER = "smtp.gmail.com"
        SMTP_PORT = 587
        EMAIL_SENDER = "sureshcud26@gmail.com"
        EMAIL_PASSWORD = app_password

        msg = MIMEMultipart()
        msg["From"] = EMAIL_SENDER
        msg["To"] = candidate_email
        msg["Subject"] = "Congratulations! You're Selected for the Next Round of MCQ Test"
...
Thank you for participating in the initial stages of our recruitment process. We are pleased to inform you that you have been shortlisted for the next round of selection, which will consist of an MCQ test. This is an exciting step toward potentially joining our team at ABC Company.<br><br>

Details of the MCQ test are as follows:<br><br>

    Date and Time: flexible<br>
    Duration: 1 Hour<br>
    Instructions: Please complete the MCQ test within 60 minutes, once you click the test link it will redirect to the test environment and the test will be started, answer all questions to the best of your ability, refrain from using external resources, and submit your test once finished;<br>
    Test Link: <a href="http://localhost:3000">Click here</a> to access the test<br><br>

Please confirm your availability for the scheduled time, and feel free to reach out if you have any questions or need assistance.<br><br>

We look forward to your continued participation in the hiring process.<br><br>
